...
},
{
  id:2,
  imgSrc : img2,
  destTitle:'Big Temple',
  location:'Tamil Nadu',
  grade:'CULTURAL HERITAGE',
  fees:'Rs 1900',
  description: 'The place of wisdom, Big Temple is one  of the best travel destinations in the World. This place is known for its luxurious stays and adventurous activities. '
},
{
  id:3,
  imgSrc : img3,
